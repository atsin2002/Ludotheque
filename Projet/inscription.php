...
if($_POST)
{
	...
	if(empty($contenu)) 
	{
		...
		else
		{
			...
			$contenu .= "<div class='validation'>Vous etes inscrit à notre site web. <a href=\"connexion.php\"><u>Cliquez ici pour vous connecter</u></a></div>";
		}
	}
}
?>
...
<form method="post" action="">
    ...
    <input type="text" id="ville" name="ville" placeholder="votre ville" pattern="[a-zA-Z0-9-_.]{5,15}" title="caract�res accept�s : a-zA-Z0-9-_."><br><br>
