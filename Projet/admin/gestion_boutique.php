...
if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification'))
{
	...
	<form method="post" enctype="multipart/form-data" action="">
		...
		<select name="taille">
			<option value="Petit"'; if(isset($produit_actuel) && $produit_actuel['taille'] == 'Petit') echo ' selected '; echo '>Petit</option>
			<option value="Moyen"'; if(isset($produit_actuel) && $produit_actuel['taille'] == 'Moyen') echo ' selected '; echo '>Moyen</option>
			<option value="Grand"'; if(isset($produit_actuel) && $produit_actuel['taille'] == 'Grand') echo ' selected '; echo '>Grand</option>
			<option value="Tres Grand"'; if(isset($produit_actuel) && $produit_actuel['taille'] == 'Tres Grand') echo ' selected '; echo '>Tres Grand</option>
		</select><br /><br />
...
require_once("C:/Program Files (x86)/EasyPHP-Devserver-17/eds-www/SitePhp/connexion.php/inc/bas.inc.php"); ?>